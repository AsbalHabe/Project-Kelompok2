...
<div class="container-fluid">
    ...
    <div class="card mx-auto shadow-lg p-3 mb-5 rounded" style="width: 65%; height: 70vh; background: linear-gradient(45deg, #3949ab, #1e88e5); color: white;">
        <div class="card-header" style="background-color: #2196f3; color: #212529; text-align: center;">
            <h3 class="mb-0">Filter Laporan Absensi</h3>
        </div>
        ...
        <form action="<?= base_url('admin/laporanAbsensi/cetakLaporanAbsensi'); ?>" method="post">
            <div class="card-body">
                ...
                <button type="submit" class="btn btn-info btn-block btn-print" style="background-color: #2196f3;"><i class="fas fa-print"></i> Cetak Laporan Absensi</button>
            </div>
        </form>
