<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h4 class="h3 mb-0 text-gray-800"><strong><?php echo $title; ?></strong></h4>
    </div>
            ...
            <tr>
                ...
                <td>
                    <div class="text-center">
                        <a class="btn btn-sm btn-warning" href="<?php echo base_url('admin/dataPegawai/detailData/' . $p->nik); ?>"><i class="fas fa-search-plus"></i></a>
